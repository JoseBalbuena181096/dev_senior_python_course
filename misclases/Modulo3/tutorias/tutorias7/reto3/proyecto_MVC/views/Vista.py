...
class VistaTienda:
    ...
    def _configurar_interfaz(self):
        ...
        self.boton_finalizar = tk.Button(self.ventana, text="Finalizr compra", command=self.controlador.finalizar_compra)
        self.boton_finalizar.pack()
    
    def _cargar_producto(self):
        for key, producto in self.controlador.obtener_productos().items():
            self.treeview_productos.insert("", "end", iid=str(id_producto), values=(producto.nombre,\
